...
This is a template example for lab journaling. Students in Matt Crump's Human Cognition and Performance Lab will use this template to learn R, and other things. Students can replace this text with more fun things. People not in my lab can use this too. Find me on my [LinkedIn](https://www.linkedin.com/in/hana-fancher001) or on [github](https://github.com/hfancher).
